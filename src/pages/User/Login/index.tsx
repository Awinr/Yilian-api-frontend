...
import { userLoginUsingPOST, userRegisterUsingPOST } from '@/services/re-api-backend/userController';
...
import nanachi from '../../../../public/nanachi.jpg';
    ...
    const handleSubmit = async (values: API.UserRegisterRequest) => {
        ...
        if (checkPassword) {
            ...
            if (res.data) {
                ...
                // 保存登录状态
                setInitialState({
                    loginUser: res.data.loginUserData,
                });
            } else {
                message.error(res.message);
            }
